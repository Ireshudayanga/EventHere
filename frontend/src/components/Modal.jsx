...
const Modal = () => {
    ...
    return (
        <dialog id="LoginModel" className="w-full max-w-md mx-auto rounded-lg overflow-hidden">
        <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 bg-[#ffffff1c]">
          <div className="relative w-full bg-white shadow-2xl rounded-2xl p-6 sm:p-10 max-w-md">
            {/* Close Button */}
            <button
