...
const EventPage = () => {
    return (
        <div className="h-screen">
            ...
            {/* Main Content */}
            <div className="bg-[#e3dddd] h-[92%] w-[94%]  mt-4 rounded-2xl shadow-md ">
                {/* Main Layout */}
                <div className="flex  h-full p-3">

                    {/* Left Section */}
                    <div className="w-[25%] h-full flex flex-col gap-5">
                        <div className="bg-white text-black p-5 rounded-2xl h-[35%]">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam, voluptates.
                        </div>
                        <div className="bg-white text-black p-5 rounded-2xl  h-[65%]">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam, voluptates.
                        </div>
                    </div>
                    ...
                    {/* Right Section */}
                    <div className="  w-[75%] h-full  text-zinc-950 flex flex-col pl-3">
                        <div className="h-2/3 overflow-y-auto">
                            <div className="bg-white text-black p-5 rounded-2xl  h-[100%]">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam, voluptates.
                        ...
                        <div className="flex gap-3 justify-between pt-3 h-1/3">
                            <div className="bg-white text-black rounded-2xl w-1/3 h-[100%] p-4 ">
