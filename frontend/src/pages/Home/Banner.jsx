...
const Banner = () => {
  return (
    <div className=" flex flex-row  w-full  mt-44 ">
      {/* Left side - Images */}
      {/* Left side - Images */}
      <div className="relative flex flex-col md:flex-row md:w-1/2">
        
        {/* Frame 1 */}
        <div className="imgframe1  md:top-[50px] md:left-0">
          <img className=" md:w-[180px] transform scale-x-[-1] mt-[50px]" src={feature01} alt="feature01" />
        </div>

        {/* Frame 2 */}
        <div className="imgframe2 m-auto md:absolute md:top-[160px] md:left-[120px]">
          <img className="w-[120px] md:w-[200px] mt-4 md:mt-[100px]" src={feature02} alt="feature02" />
        </div>

        {/* Frame 3 */}
        <div className="imgframe3 m-auto md:absolute md:left-[260px]">
          <img className="w-[120px] md:w-[180px] ml-6 my-4 md:mt-[80px]" src={feature03} alt="feature03" />
        </div>
      </div>
